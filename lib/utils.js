 ...
 */
export function compact(layout: Layout, l: LayoutItem, verticalCompact: boolean, horizontalCompact: boolean, horizontalFill: boolean): Layout {
  ...
  for (let i = 0, len = sorted.length; i < len; i++) {
    ...
    let prevL
    if (i !== 0) {
      prevL = cloneLayoutItem(sorted[i - 1]);
    }
    l.h = 5;
