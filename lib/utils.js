 ...
 */
export function compact(layout: Layout, verticalCompact: boolean, horizontalCompact: boolean, horizontalFill: boolean): Layout {
  ...
  for (let i = 0, len = sorted.length; i < len; i++) {
    ...
    if (!l.static) {
      l = compactItem(compareWith, l, verticalCompact, horizontalCompact, horizontalFill);
 ...
 */
export function compactItem(compareWith: Layout, l: LayoutItem, verticalCompact: boolean, horizontalCompact: boolean, horizontalFill: boolean): LayoutItem {
  if (horizontalCompact) {
  ...
  if (horizontalFill) {
    let totalWidth = 0
    compareWith.forEach(function(item) {
      totalWidth += item.w + item.x
    })
